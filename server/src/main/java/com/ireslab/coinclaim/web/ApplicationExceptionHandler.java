...
public class ApplicationExceptionHandler {
	...
	public ResponseEntity<BaseApiResponse> handleApiException(ApiException exp) {
		...
		baseApiResponse.setErrors(exp.getErrors());
		baseApiResponse.setCode(exp.getCode() == null ? ResponseCode.FAIL.getCode() : exp.getCode());
		baseApiResponse.setMessage(exp.getMessage());
