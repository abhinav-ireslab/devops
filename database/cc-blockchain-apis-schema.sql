...
CREATE TABLE `company_account` (
  ...
  UNIQUE KEY `UNIQUE` (`child_index`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8;

/*Data for the table `company_account` */

insert  into `company_account`(`account_id`,`company_correlation_id`,`child_index`,`status`,`btc_address`,`date_modified`) values 
(3,'4cc86e25641048788d87fad7df010601','1.00',0,'mjY73NDK27a628QiwinVD3srWDt4GWPQu6','2018-03-26 18:22:31'),
(4,'4cc86e25641048788d87fad7df010601','2.00',0,'mfo2Vqgydzo6Xadm7zKEuvq2MgZqcfbDbJ','2018-03-27 18:50:31');
